...
- [x]  `com.sprint.mission.discodeit.com.sprint.mission.service.basic` 패키지에 대해서 60% 이상의 코드 커버리지를 달성하세요.
...
- 커버리지라는 개념을 처음배워서 신기하고 흥미로웠습니다. 그런데 커버리지의 종류가 굉장히 많고 커버리지 수준도 천차만별인 것 같습니다.
  팀에서 프로젝트를 할때 커버리지 기준을 잡는다면 어떻게 잡는지가 궁금합니다!!