...
public class GlobalExceptionHandler {
  ...
  private HttpStatus determineHttpStatus(DiscodeitException exception) {
    ...
    return switch (errorCode) {
      case USER_NOT_FOUND,CHANNEL_NOT_FOUND,MESSAGE_NOT_FOUND,READSTATUS_NOT_FOUND,USERSTATUS_NOT_FOUND,BINARYCONTENT_NOT_FOUND -> HttpStatus.NOT_FOUND;
      case DUPLICATE_USER,DUPLICATE_CHANNEL,DUPLICATE_READSTATUS,DUPLICATE_USERSTATE,PRIVATE_CHANNEL_UPDATE -> HttpStatus.CONFLICT;
