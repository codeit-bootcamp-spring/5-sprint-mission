...
//         @DisplayName("USER 권한으로 공개 채널 생성 시 서비스에서 AccessDeniedException 발생하면 403 반환")
...
//                     "Access Denied", new org.springframework.security.authorization.AuthorizationDecision(false)
//                 ));
//
//             // when & then
//             mockMvc.perform(post("/api/channels/public")
...
//         @Test
//         @WithMockUser(roles = "USER")
//         @DisplayName("USER 권한으로 채널 수정 시 서비스에서 AccessDeniedException 발생하면 403 반환")
...
//         @Test
//         @WithMockUser(roles = "USER")
//         @DisplayName("USER 권한으로 채널 삭제 시 서비스에서 AccessDeniedException 발생하면 403 반환")
