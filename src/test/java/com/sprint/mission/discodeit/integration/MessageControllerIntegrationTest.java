...
public class MessageControllerIntegrationTest {
	...
	void update_success() throws Exception {
		//
		UserDto author = userService.create(new UserCreateRequest("username", "email@email", "pw!1234"),Optional.empty());
		ChannelDto channel = channelService.create(new PublicChannelCreateRequest("chName", "chDesc"));
		MessageDto created = messageService.create(new MessageCreateRequest("before", channel.id(), author.id()), List.of());
