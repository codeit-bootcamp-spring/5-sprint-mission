...
public interface ChannelService {
    ChannelDto create(PublicChannelCreateRequest request); // 오버로드 방식으로 매개변수만 다르게함
    ChannelDto create(PrivateChannelCreateRequest request); // 오버로드 방식으로 매개변수만 다르게함
    ...
    ChannelDto update(UUID channelId, PublicChannelUpdateRequest request); // 채널 수정. 지금은 공개 채널 수정 DTO만 받음
