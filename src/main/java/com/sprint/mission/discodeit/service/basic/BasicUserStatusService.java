...
public class BasicUserStatusService implements UserStatusService {
  ...
  public UserStatus addUserStatus(UUID userId) {
    userRepository.findById(userId)
        .orElseThrow(() -> new IllegalArgumentException("BasicUserStatusService: User not found"));
    userStatusRepository.findByUserId(userId)
        .ifPresent(userStatus -> {
          throw new IllegalArgumentException("BasicUserStatusService: UserStatus already exists");
        });
  ...
  public UserStatus getUserStatusById(UUID id) {
    return userStatusRepository.findById(id)
        .orElseThrow(
            () -> new IllegalArgumentException("BasicUserStatusService: UserStatus not found"));
  }
