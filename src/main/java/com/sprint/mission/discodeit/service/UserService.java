...
public interface UserService {
    // User 객체 생성 (사용자 생성)
    UserDto create(UserCreateRequest userCreateRequest, // 사용자 정보를 Dto로 받음
    ...
    UserDto update(UUID userId, UserUpdateRequest userUpdateRequest, // 식별자, 변경할 엔터티들, 사용자 정보를 Dto로 받음
                Optional<BinaryContentCreateRequest> profileCreateRequest); // 프로필 이미지 같은 바이너리 부가 데이터(없을 수도 있음)를 Dto로 받음
