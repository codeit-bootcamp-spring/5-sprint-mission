...
public interface SurveyService extends BaseService<Survey> {
    ...
    void vote(UUID surveyId, int answerIndex, UUID voterId);

    void vote(UUID surveyId, List<Integer> answerIndices, UUID voterId);

    void unvote(UUID surveyId, UUID voterId);
}
