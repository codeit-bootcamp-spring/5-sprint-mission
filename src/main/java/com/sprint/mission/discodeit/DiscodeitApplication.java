...
public class DiscodeitApplication {
    ...
    static User setupUser(UserService userService) {
        UserCreateRequest request = new UserCreateRequest("Hong", "hong1357@gmail.com", "hong1234");
    ...
    static void messageCreateTest(MessageService messageService, Channel channel, User author) {
        MessageCreateRequest request = new MessageCreateRequest("안녕하십니까?", channel.getId(), author.getId());
        ...
        + "\nWritten on " + message.getCreatedAt());
    }
