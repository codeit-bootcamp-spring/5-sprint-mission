...
public class UserController implements UserApi { // UserApi 인터페이스 구현
    ...
    public ResponseEntity<UserDto> create(
            @RequestPart("userCreateRequest") @Valid UserCreateRequest userCreateRequest, // JSON 부분 → 사용자 정보
    ...
    public ResponseEntity<UserDto> update(
            ...
            @RequestPart("userUpdateRequest") @Valid UserUpdateRequest userUpdateRequest, // JSON 부분 → 수정할 사용자 정보
