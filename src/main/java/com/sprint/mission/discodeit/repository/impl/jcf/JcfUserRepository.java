...
public class JcfUserRepository extends AbstractJcfRepository<User> implements UserRepository {
    ...
    private List<User> searchByPrefix(Function<User, String> extractor, String prefix, Comparator<User> order) {
    ...
    private List<User> searchByContains(Function<User, String> extractor, String keyword, Comparator<User> order) {
