...
@Getter
public class DevGuild extends DevBaseEntity {
    ...
    private final Set<DevGuildPermissions> permissions = new HashSet<>();
    ...
    public DevGuild(String name, boolean discoverable, UUID owner) {
        setName(name);
    ...
    public void setPermissions(UUID user, Set<Permission> permissions) {
        ...
        this.permissions.add(new DevGuildPermissions(getId(), user, granted));
        touch();
    }
